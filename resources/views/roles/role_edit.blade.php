                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="widget-box" style="margin-top: 20px;">
                            <div class="widget-header widget-header-blue widget-header-flat">
                                <h4 class="widget-title lighter">Update Role</h4>
                            </div>
                                    ...
                                    <div id="fuelux-wizard-container">
                                        ...
                                        <div class="step-content pos-rel">
                                            <div class="step-pane active" data-step="1">
                                                ...
                                                <form class="form-horizontal" role="form" action="{{ route('roles.update',$role->id) }}" method="post" enctype="multipart/form-data">
                                                    {{csrf_field()}}
                                                    @method('PUT')
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4 @if($errors->has('name')) has-error @endif">
                                                            <input type="text" id="name" class="form-control" name="name" value="{{ (old('name')) ? old('name') : $role->name }}" autofocus>
                                                            @error('name')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4 @if($errors->has('description')) has-error @endif">
                                                            <textarea class="form-control" id="description" name="description">{{ (old('description')) ? old('description') : $role->description }}</textarea>
                                                            @error('description')
